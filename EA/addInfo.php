...
<head>
    ...
    // add info function to inserting content in database
    function insertInfo($first_pic,	$title,$every_content,$cute_pic,$section_pics,$section_titles,$section_contents,$end_contents,$end_pic,$source){
        global $tb_content,$connect;
        $sql="INSERT `$tb_content` SET `first_pic`=?,`title`=?,`every_content`=?,`cute_pic`=?,`section_pics`=?,`section_titles`=?,`section_contents`=?,`end_contents`=?,`end_pic`=?,`source`=?";
...
if (isset($_POST['btn-content'])){
    if (isset($_SESSION['adminInfo'])) {
        ...
        if (!empty($_POST['first_pic']) && !empty($_POST['title']) && !empty($_POST['every_content']) && !empty($_POST['cute_pic']) && !empty($_POST['section_pics'][0]) && !empty($_POST['section_pics'][1]) && !empty($_POST['section_titles'][0]) && !empty($_POST['section_titles'][2]) && !empty($_POST['section_contents'][0]) && !empty($_POST['section_contents'][2]) && !empty($_POST['end_contents'][0]) && !empty($_POST['end_contents'][1]) && !empty($_POST['end_pic']) && !empty($_POST['source'])) {
            //end checking
            $insertInfo = insertInfo($_POST['first_pic'], $_POST['title'], $_POST['every_content'], $_POST['cute_pic'], $_POST['section_pics'], $_POST['section_titles'], $_POST['section_contents'], $_POST['end_contents'], $_POST['end_pic'],$_POST['source']);
            if ($insertInfo) {
    ...
    <header class=" ">
        <form method="post" id="content" enctype="multipart/form-data">
            <div class="row mb-3 text-muted">
                ...
                <input type="text" name="title" class="uk-input text-center" placeholder="موضوع" id="title" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['title'] : '' ;?>">
            </div>
            <div class="row text-muted ">
                <label for="first_pic" class="input-group">عکس اولیه <span class="require">*</span></label>
                <input type="hidden" role="uploadcare-uploader" data-public-key="f7132a7ffef09fea16de"  data-tabs="file camera url gdrive gphotos dropbox" data-effects="crop, blur, flip, rotate, sharp" name="first_pic"  id="first_pic"/>
            </div>
        </form>
    </header>
    <!--short explanation-->
            ...
            <div class="row justify-content-around">
                <div class="col-lg-5 col-9 mx-lg-0 mx-auto mt-5 pt-5 ">
                    ...
                    <div class="row text-muted mb-4">
                        ...
                        <textarea name="every_content" class="uk-textarea" rows="10" placeholder="توضیحاتی کوتاه وارد کن..." id="every_content" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['every_content'] : '' ;?></textarea>
                    </div>
                </div>
                <div class="col-lg-4 d-flex  justify-content-center align-items-center ">
                    <div class="text-muted mr-5">
                        ...
                        <input type="hidden" role="uploadcare-uploader" data-public-key="f7132a7ffef09fea16de"  data-tabs="file camera url gdrive gphotos dropbox" data-effects="crop, blur, flip, rotate, sharp" name="cute_pic"  id="cute_pic" form="content"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 py-5 properties">
                    <div class="property pt-5">
                        <div class="mb-2 text-muted text-center text-md-right">
                            ...
                            <input type="text" name="section_titles[]" class="uk-input  w-50" placeholder="یک ویژگی" id="section-title-1" form="content" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_titles_1'] : '' ;?>">
                        </div>
                        ...
                        <div class="explain-property">
                            <div class=" text-muted mb-2">
                                ...
                                <textarea name="section_contents[]" class="uk-textarea" rows="5" placeholder="توضیح مربوطه را وارد کن..." id="section_content-1" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_contents_1'] : '' ;?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="property py-5">
                        <div class="mb-2 text-muted text-center text-md-right">
                            ...
                            <input type="text" name="section_titles[]" class="uk-input  w-50" placeholder="یک ویژگی" id="section-title-2" form="content" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_titles_2'] : '' ;?>" >
                        </div>
                        <div class="divider mx-auto mx-md-0 my-4"></div>
                        <div class="explain-property">
                            <div class=" text-muted mb-2">
                                <label for="section_content-2">توضیح </label>
                                <textarea name="section_contents[]" class="uk-textarea" rows="5" placeholder="توضیح مربوطه را وارد کن..." id="section_content-2" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_contents_2'] : '' ;?></textarea>
                            </div>
                        </div>
                ...
                <div class="col-md-6 img img-1 pt-5">
                    <div class="row pt-5">
                        <div class="text-muted m-auto pt-5">
                            ...
                            <input type="hidden" role="uploadcare-uploader" data-public-key="f7132a7ffef09fea16de"  data-tabs="file camera url gdrive gphotos dropbox" data-effects="crop, blur, flip, rotate, sharp" name="section_pics[]"  id="section-pic-1" form="content"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 img img-1 pt-5">
                    <div class="row pt-5">
                        <div class="text-muted m-auto pt-5">
                            ...
                            <input type="hidden" role="uploadcare-uploader" data-public-key="f7132a7ffef09fea16de"  data-tabs="file camera url gdrive gphotos dropbox" data-effects="crop, blur, flip, rotate, sharp" name="section_pics[]"  id="section-pic-2" form="content"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 py-5 properties order-md-2 order-1">
                    <div class="property pt-5">
                        <div class="mb-2 text-muted  text-center text-md-right">
                            ...
                            <input type="text" name="section_titles[]" class="uk-input  w-50 " placeholder="یک ویژگی" id="section-title-3" form="content" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_titles_3'] : '' ;?>">
                        </div>
                        <div class="divider mx-auto mx-md-0 my-4"></div>
                        <div class="explain-property">
                            <div class=" text-muted mb-2">
                                <label for="section_content-3">توضیح <span class="require">*</span></label>
                                <textarea name="section_contents[]" class="uk-textarea" rows="5" placeholder="توضیح مربوطه را وارد کن..." id="section_content-3" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_contents_3'] : '' ;?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="property py-5">
                        <div class="mb-2 text-muted  text-center text-md-right">
                            ...
                            <input  type="text" name="section_titles[]" class="uk-input w-50 " placeholder="یک ویژگی" id="section-title-4" form="content" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_titles_4'] : '' ;?>">
                        </div>
                        <div class="divider mx-auto mx-md-0 my-4"></div>
                        <div class="explain-property">
                            <div class=" text-muted mb-2">
                                <label for="section_content-4">توضیح </label>
                                <textarea name="section_contents[]" class="uk-textarea" rows="5" placeholder="توضیح مربوطه را وارد کن..." id="section_content-4" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['section_contents_4'] : '' ;?></textarea>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 py-5 ">
                    <div class=" text-muted mb-4">
                        ...
                        <textarea name="end_contents[]" class="uk-textarea" rows="10" placeholder="محتوای پایانی..." id="end-content-1" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['end_contents_1'] : '' ;?></textarea>
                    </div>
                    <div class="divider mx-auto my-5 bg-warning"></div>
                    <div class=" text-muted mb-4">
                        <label for="end-content-2"><span class="require">*</span></label>
                        <textarea name="end_contents[]" class="uk-textarea" rows="10" placeholder="محتوای پایانی..." id="end-content-2" form="content"><?php echo isset($_SESSION['values']) ? $_SESSION['values']['end_contents_2'] : '' ;?></textarea>
                    </div>
                    <div class="col-lg-6">
                        <div class=" text-muted mb-4">
                            <label for="source">منبع<span class="require">*</span></label>
                            <input name="source" class="uk-input" placeholder="منبع/منابع" id="end-content-2" form="content" value="<?php echo isset($_SESSION['values']) ? $_SESSION['values']['source'] : '' ;?>">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-flex justify-content-center align-items-center ">
                    <div class="text-muted mb-5">
                        ...
                        <input type="hidden" role="uploadcare-uploader" data-public-key="f7132a7ffef09fea16de"  data-tabs="file camera url gdrive gphotos dropbox" data-effects="crop, blur, flip, rotate, sharp" name="end_pic"  id="end_pic" form="content"/>
                    </div>
                </div>
            </div>
            ...
            <section class="submit  pb-5">
                <div class="info">
                    <div class="container-fluid">
                        <div class="row">
                            <button class="btn-info btn mx-auto" type="submit" name="btn-content" form="content"><i class="fa fa-book-open"></i> ثبت مطلب جدید </button>
                        </div>
                    </div>
                </div>
            </section>
        ...
        $(function (){
            ...
            UPLOADCARE_LOCALE_TRANSLATIONS = {
                buttons: {
                    choose: {
                        files: {
                            one: 'عکسی انتخاب کنید'
                        }
                    }
                }
            }
            UPLOADCARE_PUBLIC_KEY='f7132a7ffef09fea16de';
        })
    </script>
